...
export const sendBch = async (receivers_address, amount, senders_mnemonic) => {
  console.log("Rec Address in func =", receivers_address);
  console.log("amount in func =", amount);
  console.log("mnemonic in func =", senders_mnemonic);
  let trim_mnemonic = senders_mnemonic.trim();
  console.log("trimmed mnemonic in func =", trim_mnemonic);
  try {
...
export const getBal = async (senders_mnemonic) => {
  console.log("mnemonic in getbal func = ", senders_mnemonic);
  let trim_mnemonic = senders_mnemonic.trim();
  console.log("trimmed mnemonic in func =", trim_mnemonic);
  try {
    const bchWallet = new BchWallet(trim_mnemonic, {
